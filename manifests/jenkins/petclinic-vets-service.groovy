...
'''
    ...
    stages {
        ...
        stage('Sonarqube Scan') {
            steps {
                dir('petclinic-vets-service') {
                    script {
                        withSonarQubeEnv(installationName: 'SONARQUBE') {
                            sh 'mvn clean verify sonar:sonar -Dsonar.projectKey=petclinic-vets-service -Dsonar.projectName=petclinic-vets-service'
                        }
                    }
                }
            }
        ...
        stage('Push Image and SBOM') {
            steps {
                script {
                    ...
                    def DOCKERREPO = "${PUSH_IMAGE_REGISTRY}/petclinic-vets-service"
                    ...
                    dir('petclinic-vets-service') {
                        ...
                        withCredentials([
                            ...
                            dependencyTrackPublisher(
                                ...
                                projectName: 'petclinic-vets-service',

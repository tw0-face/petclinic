...
'''
    ...
    stages {
        ...
        stage('Sonarqube Scan') {
            steps {
                dir('petclinic-frontend') {
                    script {
                        withSonarQubeEnv(installationName: 'SONARQUBE') {
                            sh 'mvn clean verify sonar:sonar -Dsonar.projectKey=petclinic-frontend -Dsonar.projectName=petclinic-frontend'
                        }
                    }
                }
            }
        ...
        stage('Push Image and SBOM') {
            steps {
                script {
                    ...
                    def DOCKERREPO = "${PUSH_IMAGE_REGISTRY}/petclinic-frontend"
                    ...
                    dir('petclinic-frontend') {
                        ...
                        withCredentials([
                            ...
                            dependencyTrackPublisher(
                                ...
                                projectName: 'petclinic-frontend',

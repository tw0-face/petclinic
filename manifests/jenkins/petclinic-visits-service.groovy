...
'''
    ...
    stages {
        ...
        stage('Sonarqube Scan') {
            steps {
                dir('petclinic-visits-service') {
                    script {
                        withSonarQubeEnv(installationName: 'SONARQUBE') {
                            sh 'mvn clean verify sonar:sonar -Dsonar.projectKey=petclinic-visits-service -Dsonar.projectName=petclinic-visits-service'
                        }
                    }
                }
            }
        ...
        stage('Push Image and SBOM') {
            steps {
                script {
                    ...
                    def DOCKERREPO = "${PUSH_IMAGE_REGISTRY}/petclinic-visits-service"
                    ...
                    dir('petclinic-visits-service') {
                        ...
                        withCredentials([
                            ...
                            dependencyTrackPublisher(
                                ...
                                projectName: 'petclinic-visits-service',
